...
function attack(emoji) {
    ...
    if (emoji === randomEmoji) {
        vsSpan === null || vsSpan === void 0 ? void 0 : vsSpan.style.setProperty('background', 'yellow');
    }
    else if ( // Win condition
    (emoji === '✌' && randomEmoji === '✋') ||
        (emoji === '👊' && randomEmoji === '✌') ||
        (emoji === '✋' && randomEmoji === '👊')) {
        vsSpan === null || vsSpan === void 0 ? void 0 : vsSpan.style.setProperty('background', 'green');
        ...
        vsSpan === null || vsSpan === void 0 ? void 0 : vsSpan.style.setProperty('background', 'red');
        points.computer++;
        if (pointsComputer) {
